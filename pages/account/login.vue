                            ...
                            <div class="p-2 mt-4">
                                ...
                                <b-form @submit.prevent="tryToLogIn">
                                    <b-form-group id="input-group-1" label="Email" label-for="input-1">
                                        <b-form-input id="input-1" v-model="email" type="text" placeholder="Enter email" :class="{ 'is-invalid': submitted && $v.email.$error }"></b-form-input>
                          ...
                          'is-invalid': submitted && $v.password.$error
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="mb-0">
                                            ...
                                            <nuxt-link to="/account/register" class="font-weight-medium text-primary">Signup now</nuxt-link>
                                        </p>
                                    </div>
                                </b-form>
                            </div>
