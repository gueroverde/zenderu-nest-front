            ...
            <div class="media-body">
              <h5 class="font-size-16 mt-0 mb-1">
                <a href="#" class="text-dark">
                  Marcus
                  <i
                    class="mdi mdi-circle text-success align-middle font-size-10 ml-1"
                  ></i>
                </a>
              </h5>
          ...
          <div class="p-3 px-lg-4 border-bottom">
            <div class="row">
              <div class="col-md-4 col-6">
                ...
                <p v-if="member !== null" class="text-muted text-truncate mb-0">
                      ...
                      <div class="ctext-wrap">
                        <div class="ctext-wrap-content">
                          <h5 class="font-size-14 conversation-name">
                            ...
                            <span
                              class="d-inline-block font-size-12 text-muted ml-2"
                              >{{ data.time }}</span
                            >
                          </h5>
